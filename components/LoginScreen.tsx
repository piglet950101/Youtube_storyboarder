  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0f0f0f] text-white p-4">
      <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl text-center">
        ...
        <h1 className="text-3xl font-black mb-2">CineGen JP</h1>
        ...
        <button 
          onClick={login}
          className="w-full bg-white text-black font-bold py-4 px-6 rounded-lg flex items-center justify-center gap-3 hover:bg-zinc-200 transition-transform active:scale-95 shadow-lg"
        >
